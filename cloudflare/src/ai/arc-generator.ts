...
export class ArcGenerator {
    ...
    constructor(env: Env) {
        ...
        this.gemini = new GeminiService(env.GOOGLE_API_KEY, 'gemini-2.0-flash-thinking-exp-1219'); // Using a strong reasoning model for planning
    }
...
`;
        ...
        console.log('[ArcGenerator] Prompt:', userPrompt);
        ...
        console.log('[ArcGenerator] Gemini Response:', responseText);

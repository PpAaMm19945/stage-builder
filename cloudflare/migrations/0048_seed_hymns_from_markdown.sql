...
For still our anc...', '<div class="hymn">
...
</div>', 'Morning_Circle', 48, 216),
('hymn_all_people_that_on_earth_do_dwell', 'All People That on Earth Do Dwell', 'liturgy', 'Worship', 'Affection', '


1. All people that on earth do dwell,
Sing to the Lord with cheerful voice.
Him serve with fear, His praise forth tell;
Come ye before Hi...', '<div class="hymn">
...
('hymn_amazing_grace', 'Amazing Grace', 'liturgy', 'Worship', 'Affection', '
...
('hymn_holy_holy_holy', 'Holy, Holy, Holy!', 'liturgy', 'Worship', 'Affection', '


1. Holy, holy, holy! Lord God Almighty!
Early in the morning our song shall rise to thee.
Holy, holy, holy! Merciful and mighty!
God in t...', '<div class="hymn">
...
('hymn_how_firm_a_foundation', 'How Firm a Foundation', 'liturgy', 'Worship', 'Affection', '


1. How firm a foundation, ye saints of the Lord,
Is laid for your faith in His excellent Word!
What more can He say than to you He hath said,<...', '<div class="hymn">
...
('hymn_it_is_well_with_my_soul', 'It Is Well with My Soul', 'liturgy', 'Worship', 'Affection', '


1. When peace, like a river, attendeth my way,
When sorrows like sea billows roll;
Whatever my lot, Thou has taught me to say,
It is well...', '<div class="hymn">
...
('hymn_love_divine_all_loves_excelling', 'Love Divine, All Loves Excelling', 'liturgy', 'Worship', 'Affection', '


1. Love divine, all loves excelling,
Joy of heaven, to earth come down;
Fix in us thy humble dwelling,
All thy faithful mercies crown.<br...', '<div class="hymn">
...
('hymn_praise_to_the_lord_the_almighty', 'Praise to the Lord, the Almighty', 'liturgy', 'Worship', 'Affection', '
...
('hymn_be_thou_my_vision', 'Be Thou My Vision', 'liturgy', 'Worship', 'Affection', '


1. Be Thou my Vision, O Lord of my heart;
Naught be all else to me, save that Thou art.
Thou my best Thought, by day or by night,
Waking ...', '<div class="hymn">
...
('hymn_great_is_thy_faithfulness', 'Great Is Thy Faithfulness', 'liturgy', 'Worship', 'Affection', '


1. Great is Thy faithfulness, O God my Father;
There is no shadow of turning with Thee;
Thou changest not, Thy compassions, they fail not;...', '<div class="hymn">
...
('hymn_rock_of_ages', 'Rock of Ages', 'liturgy', 'Worship', 'Affection', '
...
('hymn_come_thou_fount_of_every_blessing', 'Come, Thou Fount of Every Blessing', 'liturgy', 'Worship', 'Affection', '


1. Come, Thou Fount of every blessing,
Tune my heart to sing Thy grace;
Streams of mercy, never ceasing,
Call for songs of loudest praise...', '<div class="hymn">
...
('hymn_crown_him_with_many_crowns', 'Crown Him with Many Crowns', 'liturgy', 'Worship', 'Affection', '
...
('hymn_christ_the_lord_is_risen_today', 'Christ the Lord Is Risen Today', 'liturgy', 'Worship', 'Affection', '


1. Christ the Lord is risen today, Alleluia!
Sons of men and angels say, Alleluia!
Raise your joys and triumphs high, Alleluia!
Sing, ye ...', '<div class="hymn">
...
('hymn_man_of_sorrows_what_a_name', 'Man of Sorrows! What a Name', 'liturgy', 'Worship', 'Affection', '
...
('hymn_the_church_s_one_foundation', 'The Church''s One Foundation', 'liturgy', 'Worship', 'Affection', '
...
From heaven He came and soug...', '<div class="hymn">
...
('hymn_guide_me_o_thou_great_jehovah', 'Guide Me, O Thou Great Jehovah', 'liturgy', 'Worship', 'Affection', '
...
('hymn_what_a_friend_we_have_in_jesus', 'What a Friend We Have in Jesus', 'liturgy', 'Worship', 'Affection', '
...
('hymn_blessed_assurance', 'Blessed Assurance', 'liturgy', 'Worship', 'Affection', '


1. Blessed assurance, Jesus is mine!
O what a foretaste of glory divine!
Heir of salvation, purchase of God,
Born of His Spirit, washed i...', '<div class="hymn">
...
('hymn_to_god_be_the_glory', 'To God Be the Glory', 'liturgy', 'Worship', 'Affection', '


1. To God be the glory, great things He hath done;
So loved He the world that He gave us His Son,
Who yielded His life an atonement for sin,<b...', '<div class="hymn">
...
('hymn_all_hail_the_power_of_jesus_name', 'All Hail the Power of Jesus'' Name', 'liturgy', 'Worship', 'Affection', '
...
('hymn_fairest_lord_jesus', 'Fairest Lord Jesus', 'liturgy', 'Worship', 'Affection', '


1. Fairest Lord Jesus, Ruler of all nature,
O Thou of God and man the Son,
Thee will I cherish, Thee will I honor,
Thou, my soul''s glory,...', '<div class="hymn">
...
('hymn_he_leadeth_me', 'He Leadeth Me', 'liturgy', 'Worship', 'Affection', '


1. He leadeth me, O blessed thought!
O words with heavenly comfort fraught!
Whate''er I do, where''er I be,
Still ''tis God''s hand that lead...', '<div class="hymn">
...
('hymn_i_need_thee_every_hour', 'I Need Thee Every Hour', 'liturgy', 'Worship', 'Affection', '
...
('hymn_jesus_paid_it_all', 'Jesus Paid It All', 'liturgy', 'Worship', 'Affection', '
...
('hymn_just_as_i_am', 'Just as I Am', 'liturgy', 'Worship', 'Affection', '


1. Just as I am, without one plea,
But that Thy blood was shed for me,
And that Thou bidst me come to Thee,
O Lamb of God, I come, I come...', '<div class="hymn">
...
('hymn_nearer_my_god_to_thee', 'Nearer, My God, to Thee', 'liturgy', 'Worship', 'Affection', '
...
('hymn_o_for_a_thousand_tongues_to_sing', 'O For a Thousand Tongues to Sing', 'liturgy', 'Worship', 'Affection', '
...
('hymn_stand_up_stand_up_for_jesus', 'Stand Up, Stand Up for Jesus', 'liturgy', 'Worship', 'Affection', '
...
From victory unto vi...', '<div class="hymn">
...
('hymn_sweet_hour_of_prayer', 'Sweet Hour of Prayer', 'liturgy', 'Worship', 'Affection', '


1. Sweet hour of prayer! sweet hour of prayer!
That calls me from a world of care,
And bids me at my Father''s throne
Make all my wants an...', '<div class="hymn">
...
('hymn_take_my_life_and_let_it_be', 'Take My Life and Let It Be', 'liturgy', 'Worship', 'Affection', '
...
('hymn_there_is_a_fountain_filled_with_blood', 'There Is a Fountain Filled with Blood', 'liturgy', 'Worship', 'Affection', '


1. There is a fountain filled with blood
Drawn from Immanuel''s veins;
And sinners, plunged beneath that flood,
Lose all their guilty stai...', '<div class="hymn">
...
('hymn_tis_so_sweet_to_trust_in_jesus', '''Tis So Sweet to Trust in Jesus', 'liturgy', 'Worship', 'Affection', '
...
('hymn_trust_and_obey', 'Trust and Obey', 'liturgy', 'Worship', 'Affection', '
...
('hymn_turn_your_eyes_upon_jesus', 'Turn Your Eyes upon Jesus', 'liturgy', 'Worship', 'Affection', '


1. O soul, are you weary and troubled?
No light in the darkness you see?
There''s light for a look at the Savior,
And life more abundant a...', '<div class="hymn">
...
('hymn_when_i_survey_the_wondrous_cross', 'When I Survey the Wondrous Cross', 'liturgy', 'Worship', 'Affection', '


1. When I survey the wondrous cross
On which the Prince of glory died,
My richest gain I count but loss,
And pour contempt on all my prid...', '<div class="hymn">
...
('hymn_at_the_cross', 'At the Cross', 'liturgy', 'Worship', 'Affection', '
...
('hymn_count_your_blessings', 'Count Your Blessings', 'liturgy', 'Worship', 'Affection', '


1. When upon life''s billows you are tempest tossed,
When you are discouraged, thinking all is lost,
Count your many blessings, name them one b...', '<div class="hymn">
...
('hymn_doxology', 'Doxology', 'liturgy', 'Worship', 'Affection', '


Praise God, from whom all blessings flow;
Praise Him, all creatures here below;
Praise Him above, ye heavenly host;
Praise Father, Son, a...', '<div class="hymn">
...
('hymn_glory_be_to_the_father', 'Glory Be to the Father', 'liturgy', 'Worship', 'Affection', '


Glory be to the Father, and to the Son,
and to the Holy Ghost;
As it was in the beginning, is now, and ever shall be,
world without end. ...', '<div class="hymn">
...
('hymn_god_of_our_fathers', 'God of Our Fathers', 'liturgy', 'Worship', 'Affection', '
...
('hymn_have_thine_own_way_lord', 'Have Thine Own Way, Lord', 'liturgy', 'Worship', 'Affection', '


1. Have Thine own way, Lord! Have Thine own way!
Thou art the Potter, I am the clay.
Mold me and make me after Thy will,
While I am waiti...', '<div class="hymn">
...
('hymn_higher_ground', 'Higher Ground', 'liturgy', 'Worship', 'Affection', '


1. I''m pressing on the upward way,
New heights I''m gaining every day;
Still praying as I''m onward bound,
"Lord, plant my feet on higher g...', '<div class="hymn">
...
('hymn_i_surrender_all', 'I Surrender All', 'liturgy', 'Worship', 'Affection', '
...
('hymn_in_the_garden', 'In the Garden', 'liturgy', 'Worship', 'Affection', '
...
('hymn_leaning_on_the_everlasting_arms', 'Leaning on the Everlasting Arms', 'liturgy', 'Worship', 'Affection', '


1. What a fellowship, what a joy divine,
Leaning on the everlasting arms;
What a blessedness, what a peace is mine,
Leaning on the everla...', '<div class="hymn">
...
('hymn_my_jesus_i_love_thee', 'My Jesus, I Love Thee', 'liturgy', 'Worship', 'Affection', '


1. My Jesus, I love Thee, I know Thou art mine;
For Thee all the follies of sin I resign.
My gracious Redeemer, my Savior art Thou;
If ev...', '<div class="hymn">
...
('hymn_revive_us_again', 'Revive Us Again', 'liturgy', 'Worship', 'Affection', '
...
('hymn_softly_and_tenderly', 'Softly and Tenderly', 'liturgy', 'Worship', 'Affection', '


1. Softly and tenderly Jesus is calling,
Calling for you and for me;
See, on the portals He''s waiting and watching,
Watching for you and ...', '<div class="hymn">
...
('hymn_faith_of_our_fathers', 'Faith of Our Fathers', 'liturgy', 'Worship', 'Affection', '


1. Faith of our fathers, living still,
In spite of dungeon, fire and sword;
O how our hearts beat high with joy
Whene''er we hear that glo...', '<div class="hymn">

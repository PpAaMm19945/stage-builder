    ...
    if (variant === 'compact') {
        return (
            <div className={cn(
                ...
                <Progress value={percentage} className="h-1.5 bg-green-100 dark:bg-green-900/30" />
                <Button
                    variant="ghost"
                    size="sm"
    ...
    return (
        <div className={cn(
            ...
            <div className="space-y-2">
                ...
                <Progress value={percentage} className="h-3 bg-green-200 dark:bg-green-900/50" />
            ...
            <div className="grid grid-cols-4 gap-2">
                {[1, 5, 10, 'Other'].map((amount) => (
                    <Button
                        key={amount}
                        variant="outline"
                        className="bg-white dark:bg-green-900/20 border-green-300 dark:border-green-700 hover:bg-green-50 dark:hover:bg-green-900/40"
                    >
